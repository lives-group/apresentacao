...
\section{Modularizaçãoo e Extensibilidade de Linguagens}
...
\begin{frame}
 ...
 \begin{itemize}
  \item Desenvolvimento de um gerador automático de analisador sintático baseado em APEG:
   ...
   \end{itemize}
  \item Análise (métricas) de uso de DSLs em sistema reais;
  \item Estudo de formalismos e mecanismo para especificação modular de linguagens
   \begin{itemize}
